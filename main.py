# taken from https://medium.com/@Alexander_H/scraping-wikipedia-with-python-8000fc9c9e6c
# Lists compiled from https://en.wikipedia.org/wiki/Category:Lists_of_politicians
